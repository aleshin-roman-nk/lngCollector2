...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ThoughtzLand.ImplementRepo.SQLitePepo.Entities.ThoughtFlashCardDb", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.Property<int>("expression1Id")
                        .HasColumnType("INTEGER");

                    b.Property<int>("expression2Id")
                        .HasColumnType("INTEGER");
                    ...
                    b.HasIndex("expression1Id");

                    b.HasIndex("expression2Id");
            ...
            modelBuilder.Entity("ThoughtzLand.ImplementRepo.SQLitePepo.Entities.ThoughtFlashCardDb", b =>
                {
                    b.HasOne("ThoughtzLand.Core.Models.Thoughts.ThExpression", "expression1")
                        .WithMany()
                        .HasForeignKey("expression1Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ThoughtzLand.Core.Models.Thoughts.ThExpression", "expression2")
                        .WithMany()
                        .HasForeignKey("expression2Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("expression1");

                    b.Navigation("expression2");
                });
